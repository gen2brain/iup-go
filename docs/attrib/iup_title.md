...
Works only if a mnemonic is NOT defined in the title. Not valid for menus. Not supported in Win32, FLTK, Motif and Haiku (markup tags are stripped and plain text is displayed).
