...
So the **IupScrollBox** does not depend on its child's size or expansion, and its natural size is always 0x0, except for the first time when it expands to the child natural size.
