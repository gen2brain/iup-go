...
In Windows it uses the Win32 thread API. In GTK it uses the **GLib** thread API. In Qt it uses **QThread**. In other Unix systems (Motif, Cocoa, EFL) it uses the **pthreads** library.
