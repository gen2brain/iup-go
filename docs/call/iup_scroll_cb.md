...
Line and page operations are reported in Win32, Motif, GTK, Qt, WinUI, Cocoa and Haiku; the drag operations IUP_SBDRAGH/IUP_SBDRAGV only in Win32, Motif and Haiku (the others use IUP_SBPOSH/IUP_SBPOSV during a drag). GTK 4, FLTK, EFL and iOS report only IUP_SBPOSH/IUP_SBPOSV. For portability prefer reading POSX and POSY.
