...
In Windows the LEAVEWINDOW_CB/ENTERWINDOW_CB callbacks are NOT called.
In GTK, Motif and Qt the callbacks are called.

Also generated by IupDialog when the cursor leaves its area.
Not generated on Android and iOS.

### Affects

All controls with user interaction, and IupDialog.
