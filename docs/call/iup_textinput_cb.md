...
In EFL dead keys and IME composition need an Ecore_IMF module, which is selected automatically and
can be overridden with the ECORE_IMF_MODULE environment variable. Without a module each key commits
its own character.
