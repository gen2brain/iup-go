...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/elem/iupimage.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupnextfield.html
...
// It is relative to the given element and does not depend on the element currently with the focus.
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iuppreviousfield.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupgetfocus.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupsetfocus.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/elem/iupitem.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/elem/iupmenu.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/elem/iupseparator.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/elem/iupsubmenu.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupgethandle.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupgetname.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupgetallnames.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupgetalldialogs.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupsetlanguage.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupgetlanguage.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupsetlanguagestring.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupgetlanguagestring.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupsetlanguagepack.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/elem/iupclipboard.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/elem/iuptimer.html
func Timer() Ihandle {
	h := mkih(C.IupTimer())
	h.SetAttribute("UUID", uuid.NewString())
	return h
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/elem/iupthread.html
func Thread() Ihandle {
	h := mkih(C.IupThread())
	h.SetAttribute("UUID", uuid.NewString())
	return h
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/elem/iupuser.html
func User() Ihandle {
	h := mkih(C.IupUser())
	h.SetAttribute("UUID", uuid.NewString())
	return h
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupexecute.html
...
// In Windows, there is no need to add the ".exe" file extension.
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iupexecutewait.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iuphelp.html
...
//
// http://webserver2.tecgraf.puc-rio.br/iup/en/func/iuplog.html
