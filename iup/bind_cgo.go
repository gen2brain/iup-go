...
#cgo !windows,!darwin,!qt,!efl,!motif CFLAGS: -Iexternal/src/unix -DGDK_DISABLE_DEPRECATED -DGTK_DISABLE_DEPRECATED
...
#cgo winui LDFLAGS: -lwindowsapp -lruntimeobject -ld2d1 -ldwrite -luuid -loleaut32 -lole32 -luser32 -lshell32 -lgdi32 -l:libc++.a -l:libc++abi.a
