...
/*
#cgo CFLAGS: -I../external/include -I../external/src -I../external/srcgl -w

#cgo !windows,!darwin,!motif,gl CFLAGS: -I../external/src/gtk -DGDK_DISABLE_DEPRECATED -DGTK_DISABLE_DEPRECATED
#cgo !windows,!darwin,!motif,!gl CFLAGS: -I../external/src/gtk -DGDK_DISABLE_DEPRECATED -DGTK_DISABLE_DEPRECATED -DGDK_NULL
#cgo !windows,!darwin,motif CFLAGS: -I../external/src/mot
...
#cgo windows CFLAGS: -I../external/src/win -I../external/src/win/wdl -DUSE_NEW_DRAW
#cgo windows CFLAGS: -D_WIN32_WINNT=0x0601 -DWINVER=0x0601 -DCOBJMACROS -DNOTREEVIEW -DUNICODE -D_UNICODE

#cgo windows,gtk CFLAGS: -I../external/src/gtk -DGDK_DISABLE_DEPRECATED -DGTK_DISABLE_DEPRECATED -DGDK_NULL
...
#cgo darwin,!gtk CFLAGS: -I../external/src/cocoa -x objective-c
#cgo darwin,!gtk LDFLAGS: -framework SystemConfiguration -framework QuartzCore -framework Cocoa -mmacosx-version-min=10.14

#cgo darwin,gtk CFLAGS: -I../external/src/gtk -x objective-c -DGDK_DISABLE_DEPRECATED -DGTK_DISABLE_DEPRECATED -DGDK_NULL -DGTK_MAC
