...
var (
	...
	iupDrawSave                func(ih uintptr)
	iupDrawRestore             func(ih uintptr)
	iupDrawSaveLayer           func(ih uintptr, alpha int32)
	iupDrawTransform           func(ih uintptr, a, b, c, d, e, f float64)
	iupDrawSetTransform        func(ih uintptr, a, b, c, d, e, f float64)
	iupDrawResetTransform      func(ih uintptr)
	iupDrawGetTransform        func(ih uintptr, a, b, c, d, e, f *float64)
	iupDrawTranslate           func(ih uintptr, tx, ty float64)
	iupDrawScale               func(ih uintptr, sx, sy float64)
	iupDrawRotate              func(ih uintptr, angle float64)
	...
	iupDrawPathBegin               func(ih uintptr)
	iupDrawPathMoveTo              func(ih uintptr, x, y int32)
	iupDrawPathLineTo              func(ih uintptr, x, y int32)
	iupDrawPathCurveTo             func(ih uintptr, x1, y1, x2, y2, x3, y3 int32)
	iupDrawPathQuadTo              func(ih uintptr, x1, y1, x2, y2 int32)
	iupDrawPathArcTo               func(ih uintptr, cx, cy, rx, ry int32, a1, a2 float64)
	iupDrawPathClose               func(ih uintptr)
	iupDrawPathMoveToF             func(ih uintptr, x, y float64)
	iupDrawPathLineToF             func(ih uintptr, x, y float64)
	iupDrawPathCurveToF            func(ih uintptr, x1, y1, x2, y2, x3, y3 float64)
	iupDrawPathQuadToF             func(ih uintptr, x1, y1, x2, y2 float64)
	iupDrawPathArcToF              func(ih uintptr, cx, cy, rx, ry, a1, a2 float64)
	iupDrawPathCreate              func() uintptr
	iupDrawPathClear               func(path uintptr)
	iupDrawSetPath                 func(ih, path uintptr)
	iupDrawPathGetBounds           func(path uintptr, x1, y1, x2, y2 *int32)
	iupDrawPathContains            func(path uintptr, x, y, rule int32) int32
	iupDrawPathSetSvg              func(path uintptr, data string) int32
	iupDrawPathFill                func(ih uintptr, rule int32)
	iupDrawPathStroke              func(ih uintptr)
	iupDrawSetClipPath             func(ih uintptr, rule int32)
	iupDrawSetSourceSolid          func(ih uintptr, color string)
	iupDrawSetSourceLinearGradient func(ih uintptr, x1, y1, x2, y2 int32, angle float32, colors *uintptr, offsets *float32, count int32)
	iupDrawSetSourceRadialGradient func(ih uintptr, cx, cy, radius int32, colors *uintptr, offsets *float32, count int32)
	iupDrawResetSource             func(ih uintptr)
...
func ensureBase() {
	baseOnce.Do(func() {
		...
		reg(&iupDrawSave, "IupDrawSave")
		reg(&iupDrawRestore, "IupDrawRestore")
		reg(&iupDrawSaveLayer, "IupDrawSaveLayer")
		reg(&iupDrawTransform, "IupDrawTransform")
		reg(&iupDrawSetTransform, "IupDrawSetTransform")
		reg(&iupDrawResetTransform, "IupDrawResetTransform")
		reg(&iupDrawGetTransform, "IupDrawGetTransform")
		reg(&iupDrawTranslate, "IupDrawTranslate")
		reg(&iupDrawScale, "IupDrawScale")
		reg(&iupDrawRotate, "IupDrawRotate")
		...
		reg(&iupDrawPathBegin, "IupDrawPathBegin")
		reg(&iupDrawPathMoveTo, "IupDrawPathMoveTo")
		reg(&iupDrawPathLineTo, "IupDrawPathLineTo")
		reg(&iupDrawPathCurveTo, "IupDrawPathCurveTo")
		reg(&iupDrawPathQuadTo, "IupDrawPathQuadTo")
		reg(&iupDrawPathArcTo, "IupDrawPathArcTo")
		reg(&iupDrawPathClose, "IupDrawPathClose")
		reg(&iupDrawPathMoveToF, "IupDrawPathMoveToF")
		reg(&iupDrawPathLineToF, "IupDrawPathLineToF")
		reg(&iupDrawPathCurveToF, "IupDrawPathCurveToF")
		reg(&iupDrawPathQuadToF, "IupDrawPathQuadToF")
		reg(&iupDrawPathArcToF, "IupDrawPathArcToF")
		reg(&iupDrawPathCreate, "IupDrawPathCreate")
		reg(&iupDrawPathClear, "IupDrawPathClear")
		reg(&iupDrawSetPath, "IupDrawSetPath")
		reg(&iupDrawPathGetBounds, "IupDrawPathGetBounds")
		reg(&iupDrawPathContains, "IupDrawPathContains")
		reg(&iupDrawPathSetSvg, "IupDrawPathSetSvg")
		reg(&iupDrawPathFill, "IupDrawPathFill")
		reg(&iupDrawPathStroke, "IupDrawPathStroke")
		reg(&iupDrawSetClipPath, "IupDrawSetClipPath")
		reg(&iupDrawSetSourceSolid, "IupDrawSetSourceSolid")
		reg(&iupDrawSetSourceLinearGradient, "IupDrawSetSourceLinearGradient")
		reg(&iupDrawSetSourceRadialGradient, "IupDrawSetSourceRadialGradient")
		reg(&iupDrawResetSource, "IupDrawResetSource")
