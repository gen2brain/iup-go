...
//go:generate rsrc --manifest ../external/iup.manifest --arch 386 -o manifest_windows_386.syso
//go:generate rsrc --manifest ../external/iup.manifest --arch amd64 -o manifest_windows_amd64.syso
//go:generate rsrc --manifest ../external/iup.manifest --arch arm64 -o manifest_windows_arm64.syso
