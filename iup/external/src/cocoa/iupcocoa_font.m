...
static char * cocoaSystemFontName(void)
{
...
static int cocoaFontGetFamilyList(char*** list)
{
  @autoreleasepool {
...
{
  @autoreleasepool {
    return cocoaFontGetFamilyList(list);
  }
}

static void cocoaFontInit(void)
{
  if (nil == s_mapOfFonts)
  {
...
static void cocoaFontFinish(void)
{
