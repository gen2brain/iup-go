/** \file
 * \brief Haiku Sensor (no system sensor service)
 *
...
extern "C" IUP_SDK_API int iupdrvSensorIsAvailable(int type) { (void)type; return 0; }
...
extern "C" IUP_SDK_API void iupdrvSensorStop(Ihandle* ih) { (void)ih; }
...
extern "C" IUP_SDK_API void iupdrvSensorInitClass(Iclass* ic) { (void)ic; }
