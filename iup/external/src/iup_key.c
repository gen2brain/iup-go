...
void iupKeyInit(void)
{
  ...
  ikey_map_ext[0x8D] = "K_KP_CR";
  ikey_map_ext[0x95] = "K_KP_HOME";
  ikey_map_ext[0x96] = "K_KP_LEFT";
  ikey_map_ext[0x97] = "K_KP_UP";
  ikey_map_ext[0x98] = "K_KP_RIGHT";
  ikey_map_ext[0x99] = "K_KP_DOWN";
  ikey_map_ext[0x9A] = "K_KP_PGUP";
  ikey_map_ext[0x9B] = "K_KP_PGDN";
  ikey_map_ext[0x9C] = "K_KP_END";
  ikey_map_ext[0x9D] = "K_KP_MIDDLE";
  ikey_map_ext[0x9E] = "K_KP_INS";
  ikey_map_ext[0x9F] = "K_KP_DEL";
  ikey_map_ext[0xAA] = "K_KP_MULT";
  ikey_map_ext[0xAB] = "K_KP_PLUS";
  ikey_map_ext[0xAC] = "K_KP_SEP";
  ikey_map_ext[0xAD] = "K_KP_MINUS";
  ikey_map_ext[0xAE] = "K_KP_DECIMAL";
  ikey_map_ext[0xAF] = "K_KP_DIV";
  ikey_map_ext[0xB0] = "K_KP_0";
  ikey_map_ext[0xB1] = "K_KP_1";
  ikey_map_ext[0xB2] = "K_KP_2";
  ikey_map_ext[0xB3] = "K_KP_3";
  ikey_map_ext[0xB4] = "K_KP_4";
  ikey_map_ext[0xB5] = "K_KP_5";
  ikey_map_ext[0xB6] = "K_KP_6";
  ikey_map_ext[0xB7] = "K_KP_7";
  ikey_map_ext[0xB8] = "K_KP_8";
  ikey_map_ext[0xB9] = "K_KP_9";
  ikey_map_ext[0xBD] = "K_KP_EQUAL";
