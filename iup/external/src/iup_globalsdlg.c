...
static iRegisteredGlobal global_attribs[] = {
  { "APPID", 0, 0, 1, 0, 1, 0 },
  { "APPNAME", 1, 0, 0, 1, 1, 0 },
  { "APPSHELL", 0, 1, 1, 0, 0, 1 },
  { "ARGV0", 0, 0, 1, 0, 1, 0 },
  { "AUTOREPEAT", 0, 1, 0, 0, 0, 0 },
  { "COMCTL32VER6", 1, 0, 0, 0, 0, 1 },
  { "COMPUTERNAME", 1, 1, 1, 1, 1, 1 },
  { "CONTROLKEY", 1, 1, 1, 1, 1, 1 },
  { "COPYRIGHT", 1, 1, 1, 1, 1, 1 },
  { "CURSORPOS", 1, 1, 1, 1, 1, 0 },
  { "DARKMODE", 1, 0, 1, 1, 1, 1 },
  { "DEFAULTBUTTONPADDING", 1, 1, 1, 1, 1, 0 },
  { "DEFAULTDECIMALSYMBOL", 1, 1, 1, 1, 1, 0 },
  { "DEFAULTFONT", 1, 1, 1, 1, 1, 0 },
  { "DEFAULTFONTFACE", 1, 1, 1, 1, 1, 0 },
  { "DEFAULTFONTSIZE", 1, 1, 1, 1, 1, 0 },
  { "DEFAULTFONTSTYLE", 1, 1, 1, 1, 1, 0 },
  { "DEFAULTPRECISION", 1, 1, 1, 1, 1, 0 },
  { "DEFAULTTHEME", 1, 1, 1, 1, 1, 0 },
  ...
  { "EXITLOOP", 1, 1, 1, 1, 1, 0 },
  { "FREETYPEFONTS_DIR", 1, 1, 1, 1, 1, 0 },
  { "FULLSIZE", 1, 1, 1, 1, 1, 1 },
  { "GDK_WINDOWING", 0, 0, 1, 0, 0, 1 },
  { "GLOBALLAYOUTDLGKEY", 1, 1, 1, 1, 1, 0 },
  { "GLOBALLAYOUTRESIZEKEY", 1, 1, 1, 1, 1, 0 },
  { "GLOBALMENU", 0, 0, 1, 0, 0, 0 },
  { "GL_RENDERER", 1, 1, 1, 1, 1, 1 },
  { "GL_VENDOR", 1, 1, 1, 1, 1, 1 },
  { "GL_VERSION", 1, 1, 1, 1, 1, 1 },
  { "GTKDEVVERSION", 0, 0, 1, 0, 0, 1 },
  { "GTKVERSION", 0, 0, 1, 0, 0, 1 },
  { "HELPAPP", 0, 1, 1, 0, 0, 0 },
  { "HINSTANCE", 1, 0, 0, 0, 0, 1 },
  { "ICON", 1, 1, 1, 1, 1, 0 },
  { "IMAGEAUTOSCALE", 1, 1, 1, 1, 1, 0 },
  { "IMAGEEXPORT_STATIC", 1, 1, 1, 1, 1, 0 },
  { "IMAGESDPI", 1, 1, 1, 1, 1, 0 },
  { "IMAGESTOCKAUTOSCALE", 1, 1, 1, 1, 1, 0 },
  { "IMAGESTOCKSIZE", 1, 1, 1, 1, 1, 0 },
  { "INPUTCALLBACKS", 1, 1, 1, 1, 1, 0 },
  { "IUPIM_LASTERROR", 1, 1, 1, 1, 1, 1 },
  { "IUPLUA_THREADED", 1, 1, 1, 1, 1, 0 },
  { "KEY", 1, 1, 1, 1, 1, 1 },
  { "KEYPRESS", 1, 1, 1, 1, 1, 1 },
  { "KEYRELEASE", 1, 1, 1, 1, 1, 1 },
  { "LANGUAGE", 1, 1, 1, 1, 1, 0 },
  { "LASTERROR", 1, 0, 0, 0, 0, 0 },
  { "LEXERLUA", 1, 1, 1, 1, 1, 0 },
  { "LINKFGCOLOR", 1, 1, 1, 1, 1, 0 },
  { "LOCKLOOP", 1, 1, 1, 1, 1, 0 },
  { "LUA_ERROR_LABEL", 1, 1, 1, 1, 1, 0 },
  { "MENUBGCOLOR", 1, 0, 0, 1, 1, 0 },
  { "MENUFGCOLOR", 1, 0, 0, 1, 1, 1 },
  { "MGLFONTS", 1, 1, 1, 1, 1, 0 },
  { "MODKEYSTATE", 1, 1, 1, 1, 1, 1 },
  { "MONITORSCOUNT", 1, 0, 1, 1, 1, 1 },
  { "MONITORSINFO", 1, 0, 1, 1, 1, 1 },
  { "MOTIFNUMBER", 0, 1, 0, 0, 0, 1 },
  { "MOTIFVERSION", 0, 1, 0, 0, 0, 1 },
  { "MOUSEBUTTON", 1, 1, 1, 1, 1, 1 },
  { "OVERLAYSCROLLBAR", 0, 0, 1, 0, 0, 0 },
  { "PARENTDIALOG", 1, 1, 1, 1, 1, 0 },
  { "QTPLATFORM", 0, 0, 0, 0, 1, 1 },
  { "QTBUILDTYPE", 0, 0, 0, 0, 1, 1 },
  { "QTDEVVERSION", 0, 0, 0, 0, 1, 1 },
  { "QTSTYLE", 0, 0, 0, 0, 1, 1 },
  { "QTVERSION", 0, 0, 0, 0, 1, 1 },
  { "SB_BGCOLOR", 0, 1, 1, 0, 0, 0 },
  { "SCINTILLA_VERSION", 1, 1, 1, 1, 1, 1 },
  { "SCREENDEPTH", 1, 1, 1, 1, 1, 1 },
  { "SCREENDPI", 1, 1, 1, 1, 1, 1 },
  { "SCREENSIZE", 1, 1, 1, 1, 1, 1 },
  { "SCROLLBARSIZE", 1, 1, 1, 1, 1, 1 },
  { "SHIFTKEY", 1, 1, 1, 1, 1, 1 },
  { "SHOWMENUIMAGES", 0, 0, 1, 0, 1, 0 },
  { "SINGLEINSTANCE", 1, 0, 0, 0, 0, 0 },
  { "SYSTEM", 1, 1, 1, 1, 1, 1 },
  { "SYSTEMLANGUAGE", 1, 1, 1, 1, 1, 1 },
  { "SYSTEMLOCALE", 1, 1, 1, 1, 1, 1 },
  { "SYSTEMVERSION", 1, 1, 1, 1, 1, 1 },
  { "TREEIMAGE24", 1, 1, 1, 1, 1, 0 },
  { "TRUECOLORCANVAS", 1, 1, 1, 1, 1, 1 },
  { "TXTBGCOLOR", 1, 1, 1, 1, 1, 0 },
  { "TXTFGCOLOR", 1, 1, 1, 1, 1, 0 },
  { "TXTHLCOLOR", 1, 1, 1, 1, 1, 0 },
  { "USERNAME", 1, 1, 1, 1, 1, 1 },
  { "UTF8MODE", 1, 0, 1, 1, 1, 0 },
  { "UTF8MODE_FILE", 1, 0, 0, 0, 0, 0 },
  { "VERSION", 1, 1, 1, 1, 1, 1 },
  { "VIRTUALSCREEN", 1, 0, 1, 1, 1, 1 },
  { "XDISPLAY", 0, 1, 1, 0, 0, 1 },
  { "XSCREEN", 0, 1, 1, 0, 0, 1 },
  { "XSERVERVENDOR", 0, 1, 1, 0, 0, 1 },
  { "XVENDORRELEASE", 0, 1, 1, 0, 0, 1 },
  { "WL_DISPLAY", 0, 0, 1, 0, 0, 1 },
  { NULL, 0, 0, 0, 0, 0, 0 }
};
