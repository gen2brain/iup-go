  ...
  case WM_RBUTTONDOWN:
    {
      ...
      if (msg == WM_LBUTTONDOWN && iupAttribGetBoolean(ih, "DRAGSOURCE"))
      {
        ...
        {
          /* Did not start a drag, but it will process the WM_LBUTTONUP message internally,
...
IUP_SDK_API void iupdrvCanvasInitClass(Iclass* ic)
{
  ...
  /* Visual */
  iupClassRegisterAttribute(ic, "BGCOLOR", NULL, winCanvasSetBgColorAttrib, IUPAF_SAMEASSYSTEM, "DLGBGCOLOR", IUPAF_DEFAULT);
